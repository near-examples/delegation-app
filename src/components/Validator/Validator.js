...
const Validator = (props) => {
    ...
    const {
        ...
        contract: {
            contractId, staked, unstaked, unstakedAvailable
        }
    } = props
    ...
    return <Root>
        ...
        >
            {
                selected ?
                    <SelectedView {...{ selectedAction, contractId, staked, unstaked,  }} /> :
                    hasStake ?
                        <StakedView {...{ contractId, unstaked, staked, unstakedAvailable }} /> :
